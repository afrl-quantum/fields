...
#ifndef fields_Fields_h
#define fields_Fields_h
...
namespace fields {
   ...
   */
  template <class T>
  struct BgField : public virtual BaseField {
    /* TYPEDEFS */
    ...
    /* MEMBER FUNCTIONS */
    BgField( const T & bg = 0.0 ) : super(), bg(bg) { }
  ...
  public:
    ...
    inline void operator()( typename F0::base & F,
